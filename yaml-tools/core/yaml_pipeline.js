...
async function runPipeline() {
  ...
  const combineSuccess = await runCommand(combineCmd, 'Combining all files back into a single YAML file');
  ...
  const loadResponse = await question('Do you want to load the data into the database now? (y/n): ');
