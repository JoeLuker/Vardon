...
export async function runCapabilityTest() {
	...
	console.log(
		`Strength: ${strScore} (Modifier: ${abilityCapability.getAbilityModifier(entity, 'strength')})`
	);
	console.log(
		`Dexterity: ${dexScore} (Modifier: ${abilityCapability.getAbilityModifier(entity, 'dexterity')})`
	);
	console.log(
		`Intelligence: ${intScore} (Modifier: ${abilityCapability.getAbilityModifier(entity, 'intelligence')})`
	);
	...
	console.log(
		`Strength is now ${abilityCapability.getAbilityScore(entity, 'strength')} (Modifier: ${abilityCapability.getAbilityModifier(entity, 'strength')})`
	);
