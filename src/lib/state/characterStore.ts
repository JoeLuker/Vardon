 ...
 */
async function handleCharacterTableChange(_type: 'insert' | 'update' | 'delete', row: any) {
 ...
 * 3) Attempt DB update
 */
export async function updateCharacterOptimistically(changes: Partial<CompleteCharacter>) {
