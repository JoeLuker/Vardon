/**
 * Unix Character Adapter
 *
 * This adapter translates between the Unix architecture's Entity format
...
/**
 * Converts a Unix Entity to an AssembledCharacter for UI components
 */
