...
<Card.Root>
	<Card.Header>
		...
		<Card.Description>Feature prerequisites and requirements</Card.Description>
	</Card.Header>
	<Card.Content>
		{#if !character}
		...
		{:else}
			<div class="space-y-6">
				{#if prerequisites.length > 0}
					<div>
						<h3 class="mb-2 text-lg font-semibold">Fulfilled Prerequisites</h3>
				...
				{#if missingPrerequisites.length > 0}
					<div>
						<h3 class="mb-2 text-lg font-semibold">Missing Prerequisites</h3>
						<div class="grid gap-2">
