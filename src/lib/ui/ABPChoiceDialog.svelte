...
<script lang="ts">
	...
	const abpChoicesByLevel = {
		...
		14: {
			...
			options: [
				{ id: 'split_bonus', label: 'Split Bonus', value: 'split', description: '+2 to both armor and weapons' },
				{ id: 'single_bonus', label: 'Focused Bonus', value: 'single', description: '+3 to either armor or weapons' }
			]
		},
		19: {
			...
			options: [
				{ id: 'legendary_ability', label: 'Legendary Ability', value: 'ability', description: '+1 to all ability scores' },
				{ id: 'legendary_defense', label: 'Legendary Defense', value: 'defense', description: '+5 natural armor' },
				{ id: 'legendary_magic', label: 'Legendary Magic', value: 'magic', description: 'SR 21 + character level' }
			]
		}
	};
		...
		<div class="space-y-4">
			{#if availableChoices.length === 0}
				<p class="text-muted-foreground">
					No ABP choices are currently available. Choices become available at levels 6, 7, 14, and 19.
				</p>
			{:else}
