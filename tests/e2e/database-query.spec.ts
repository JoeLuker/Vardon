...
test.describe('Database Query Interface E2E Tests', () => {
	...
	test.describe('Results Display', () => {
		test('should paginate large result sets', async ({ page }) => {
			...
			const pagination = page.locator(
				'.pagination, .page-controls, button:has-text("Next"), button:has-text("Previous")'
			);
	...
	test.describe('Query Builder', () => {
		test('should provide visual query builder', async ({ page }) => {
			...
			const builderToggle = page.locator(
				'button:has-text("Builder"), [role="tab"]:has-text("Visual"), .query-builder-toggle'
			);
	...
	test.describe('Schema Explorer', () => {
		test('should show database schema', async ({ page }) => {
			...
			const schemaExplorer = page.locator(
				'.schema-explorer, .database-schema, aside:has-text("Tables")'
			);
