...
test.describe('Visual Regression Tests', () => {
	...
	test.describe('Character Sheet Visual Tests', () => {
		...
		test('character header appearance', async ({ page }) => {
			const header = page
				.locator('.character-header, header, [data-testid="character-header"]')
				.first();
		...
		test('ability scores section', async ({ page }) => {
			const abilitySection = page
				.locator('.ability-scores, [data-testid="ability-scores"]')
				.first();
		...
		test('combat stats section', async ({ page }) => {
			const combatSection = page
				.locator('.ac-stats, .combat-stats, [data-testid="combat-stats"]')
				.first();
