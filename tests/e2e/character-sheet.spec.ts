...
test.describe('Character Sheet E2E Tests', () => {
  ...
  test.describe('Character Loading', () => {
    ...
    test('should handle invalid character ID gracefully', async ({ page }) => {
      ...
      const errorIndicators = page.locator('.error-message, [role="alert"], :text("not found"), :text("error")');
  ...
  test.describe('Character Header Display', () => {
    ...
    test('should display character name and basic info', async ({ page }) => {
      ...
      if (await characterHeader.count() > 0) {
        ...
        const levelInfo = characterHeader.locator(':text("Level"), :text("level"), .character-level');
    ...
    test('should display hit points', async ({ page }) => {
      const hpSection = page.locator('[data-testid="hp-section"], .hp-tracker, :text("Hit Points"), :text("HP")');
  ...
  test.describe('Skills Section', () => {
    ...
    test('should show skill modifiers', async ({ page }) => {
      ...
      const skillModifiers = page.locator('.skill-modifier, .skill-bonus, [class*="skill"] text=/[+-]?\\d+/');
  ...
  test.describe('Combat Stats', () => {
    test('should display AC values', async ({ page }) => {
      ...
      const acSection = page.locator('.ac-stats, [data-testid="ac-stats"], :text("Armor Class"), :text("AC")');
  ...
  test.describe('Character Features', () => {
    test('should display class features', async ({ page }) => {
      ...
      const featuresSection = page.locator('.class-features, [data-testid="class-features"], :text("Class Features")');
  ...
  test.describe('Error Handling', () => {
    test('should show loading state', async ({ page }) => {
      ...
      const loadingIndicators = page.locator('.loading, [data-testid="loading"], :text("Loading"), .spinner, .skeleton');
