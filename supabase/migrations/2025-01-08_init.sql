...
create table
  ancestry_attribute (
    ...
    attribute_id bigint not null references ref_attribute (id) on delete cascade,
...
create table
  buff (
    ...
    name text not null,
    label text,
    buff_type_id bigint references ref_buff_type (id),
    created_at TIMESTAMPTZ default now(),
    updated_at TIMESTAMPTZ default now()
  );
...
create table
  equipment (
    ...
    slot text,
    bonus int,
    bonus_type_id bigint references ref_bonus_type(id),
    weight numeric,
    cost numeric,
    created_at TIMESTAMPTZ default now(),
    updated_at TIMESTAMPTZ default now()
...
create table
  game_character_skill_rank (
    ...
    game_character_id bigint not null references game_character (id) on delete cascade,
    skill_id bigint not null references skill (id) on delete cascade,
    source_id bigint references ref_skill_rank_source (id),
