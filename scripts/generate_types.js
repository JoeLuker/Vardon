...
console.log(
	`${colors.bright}${colors.fg.cyan}Generating Supabase TypeScript definitions...${colors.reset}`
);
...
try {
	...
	console.log(
		`${colors.fg.white}Helper types available at:${colors.reset} src/lib/types/supabase.ts`
	);
