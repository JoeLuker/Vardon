...
const PROD_SUPABASE_ANON_KEY =
	'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InB4b3Nma3Bnc3Fra2ZodGZrZG9nIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzA2MDU3OTAsImV4cCI6MjA0NjE4MTc5MH0.AIiRrXZNiac7lB6MiAs9zOCWcYDqUqwlE55Ymp-60uI';
...
async function compareEnvironments() {
	...
	for (const tableName of tablesToCheck) {
		...
		console.log(
			`| ${tableName.padEnd(13)} | ${String(localCount).padEnd(6)} | ${String(prodCount).padEnd(10)} | ${status} |`
		);
